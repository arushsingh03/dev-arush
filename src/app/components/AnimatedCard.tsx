...
export function AnimatedCard({
  className,
  title = "Default Title",
  description = "This is a default description for the animated card. You can customize it by passing props.",
  icons = [
    {
  ...
  return (
    <div
      className={cn(
        "max-w-sm w-full mx-auto p-8 rounded-xl border border-[rgba(255,255,255,0.10)] shadow-[2px_4px_16px_0px_rgba(0,0,0,0.6)_inset] group",
        className
      )}
    >
      <div
        className={cn(
          ...
          "bg-[rgba(30,30,30,0.8)] [mask-image:radial-gradient(50%_50%_at_50%_50%,white_0%,transparent_100%)]"
        )}
      >
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      shadow-[0px_0px_8px_0px_rgba(255,255,255,0.15)_inset,0px_32px_24px_-16px_rgba(0,0,0,0.60)]`,
      className
    )}
    {...props}
  />
...
export { ClaudeLogo, CopilotLogo, OpenAILogo, GeminiLogo, MetaIconOutline };
